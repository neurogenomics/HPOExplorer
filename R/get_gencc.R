get_gencc <- function(agg_by=c("disease_curie",
  ...
  DatabaseID <- disease_original_curie <- classification_title <- NULL;
  ...
  d[,DatabaseID:=gsub("^Orphanet","ORPHA",disease_original_curie)]
