...
#' branches.
#'
#' @param highlighted_branches Names of branches you want to highlight <vector<string>>
#' @param background_branches HPO Ids of all branches to be shown (including highlighted) <vector<string>>
#' @param wes_anderson_palette Name of desired color palette, see options above <string>
#' @param phenotype_to_genes The phenotype_to_genes file from HPO giving phenotype gene lists <data.frame>
#' @param hpo The HPO data object from ontologyIndex package.
#' @import ggplot2
#' @examples
#' \dontrun{
# Selecting child terms of "Abnormality of the nervous system" as background branches"
